...
I'm a passionate and detail-oriented Full Stack Developer with expertise in building scalable applications and creating intuitive user experiences. Currently working as a Product Development Engineer at Mahindra Comviva, I specialize in optimizing web applications with Angular and REST APIs.

### 🚀 What I do

- Design & develop high-performance web applications
- Create reusable UI components that enhance user experience
- Optimize frontend performance through efficient code patterns
- Collaborate with backend teams to streamline API integration
- Improve data handling with database optimization techniques
...
- Reduced page load time by 40% through code refactoring and optimization techniques
- Improved user satisfaction by 25% through UI/UX enhancements and usability testing
- Enhanced ETL pipeline efficiency by 30% through improved data synchronization
- Developed 100+ automated mobile app test cases for robust quality assurance
